   ...
   .loader {
    ...
    <body>
      ...
      <div id="divsettings" class="display-none d-none">{{json_encode($Settings)}}</div>
        ...
        <img src="{{url('/')}}/App/assests/Images/Book.gif" alt="Loading...">
    </div>
                ...
                <div class="navbar-custom">
                    <div class="topbar">
                        ...
                        <ul class="topbar-menu d-flex align-items-center">
                            ...
                            <!-- User Dropdown -->
                            <li class="dropdown">
                                <a id="myDropdownToggle" class="nav-link dropdown-toggle nav-user me-0 waves-effect waves-light" data-bs-toggle="dropdown"  role="button" aria-haspopup="false" aria-expanded="false">
                                    <img src="{{url('/')}}/{{$UInfo->ProfileImage}}" alt="user-image" class="rounded-circle">
                                    <span class="ms-1 d-none d-md-inline-block">
                                      {{$UInfo->Name}} <i class="mdi mdi-chevron-down"></i>
                                    </span>
                                </a>
                                <div id="myDropdownMenu" style="display: none;" class="dropdown-menu dropdown-menu-end profile-dropdown">
                                    <!-- item-->
                                    <div class="dropdown-header noti-title">
        ...
        <div class="offcanvas offcanvas-end right-bar" tabindex="-1" id="theme-settings-offcanvas">
            ...
            <div class="offcanvas-footer border-top py-2 px-2 text-center">
                <div class="d-flex gap-2">
                    ...
                    <a href="#" class="btn btn-primary w-50" target="_blank"><i class="mdi mdi-home me-1"></i> Home</a>
                </div>
            </div>
        </div>
      ...
      <script src="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/js/all.min.js" crossorigin="anonymous"></script>
        ...
        <script>
// Get the dropdown toggle element by ID
const dropdownToggle = document.getElementById('myDropdownToggle');

// Get the dropdown menu element by ID
const dropdownMenu = document.getElementById('myDropdownMenu');
...
dropdownToggle.addEventListener('click', () => {
  ...
  if (dropdownMenu.style.display === 'block') {
    ...
    // Show the dropdown menu below the toggle element
...
function showLoader() {
        ...
        // Example: AJAX loader handling (assuming jQuery is used)
